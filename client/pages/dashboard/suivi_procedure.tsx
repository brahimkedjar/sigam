...
const STATUS_CONFIG = {
  'Type de permis': { bg: styles['bg-blue-100'], text: styles['text-blue-800'], icon: <FiClock className={styles['text-blue-500']} /> },
...
export default function SuiviDemandes() {
  ...
  useEffect(() => {
    ...
    if (currentView === 'procedures' && isMounted) {
