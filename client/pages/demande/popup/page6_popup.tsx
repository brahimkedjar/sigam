...
export default function SummaryModal({ data, onClose }: SummaryModalProps) {
  ...
  const handleConfirm = () => {
    setIsLoading(true);
    router.push(`/demande/step6/page6?id=${data.id_proc}`);
  };

  const demande = data;
  const procedure = demande.procedure;
  const detenteur = demande.detenteur;
  const registre = detenteur?.registreCommerce;
        ...
        <div className={styles['modal-content']}>
          ...
          <div className={styles['modal-section']}>
            <div className={styles['section-header']}>
              ...
              <h3 className={styles['section-title']}>Identification de l`&apos`entité</h3>
            </div>
              ...
              <>
                <div className={styles['info-grid']}>
                  ...
                  <div className={styles['info-item']}>
                    ...
                    <span className={styles['info-value']}>{registre?.adresse_legale ?? '—'}</span>
                  </div>
                  <div className={styles['info-item']}>
