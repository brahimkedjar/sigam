            ...
            {filteredItems().length === 0 ? (
              ...
              (filteredItems() as Wilaya[]).map((item: Wilaya) => (
                <div key={item.id_wilaya} className={styles.card}>
                  <div className={styles.cardHeader}>
                    <h3>{item.nom_wilaya} ({item.code_wilaya})</h3>
                    <div className={styles.actions}>
                      <button
                        className={styles.editButton}
    ...
    {filteredItems().length === 0 ? (
      ...
      (filteredItems() as Daira[]).map((item: Daira) => (
        <div key={item.id_daira} className={styles.card}>
          <div className={styles.cardHeader}>
            <h3>{item.nom_daira} ({item.code_daira})</h3>
            <div className={styles.actions}>
              <button
                className={styles.editButton}
          ...
          {expandedItem === item.id_daira && (
            <div className={styles.cardDetails}>
              <div className={styles.detailRow}>
                <span>Wilaya:</span>
                <span>{item.wilaya.nom_wilaya}</span>
              </div>
              <div className={styles.detailRow}>
                <span>Antenne:</span>
                ...
                <div key={item.id_commune} className={styles.card}>
                  ...
                  {expandedItem === item.id_commune && (
                    <div className={styles.cardDetails}>
                      <div className={styles.detailRow}>
                        <span>Daira:</span>
                        <span>{item.daira.nom_daira}</span>
                      </div>
                      <div className={styles.detailRow}>
                        <span>Wilaya:</span>
                        <span>{item.daira.wilaya.nom_wilaya}</span>
                      </div>
                      <div className={styles.detailRow}>
                        <span>Antenne:</span>
