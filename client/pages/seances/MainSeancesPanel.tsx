// components/seances/SeanceManager.tsx
'use client';
...
export default function SeanceManager() {
  ...
  const openEditModal = (seance: Seance) => {
    ...
    setFormData({
      ...
      selectedMembers: seance.membres.map(m => m.id_membre),
      selectedProcedures: seance.procedures.map(p => p.id_proc),
                  ...
                  <tr key={seance.id_seance}>
                    ...
                    <td>
                      <div className={styles.avatarGroup}>
                        {seance.membres.slice(0, 3).map(member => (
